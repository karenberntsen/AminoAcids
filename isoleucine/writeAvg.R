...
scaleslist<-list("variable"="_yscaled","fixed"="_fixed");
text1<-readLines("text14.txt");
text0<-paste('<h1>Mean &chi;1 and mean &chi;2 of ',getLongName(aas),' per resolution</h1>',sep="");
...
setwd(paste("/home/stage/karenb/Documents/Verslag/AminoAcids",getLongName(aas),"/Figures/",aas,"/R/Avg",sep=""));
fileName<-paste('Avg_',binsizelist[bs],dat,aas,'_Quadrant_',Qlist[Q],"_chi",chi,scale,'.png',sep="");
...
string<-paste('<img border=0 hspace=2 src="Figures/',aas,'/R/Avg/Avg_',binsizelist[bs],dat,aas,'_Quadrant_',Q,"_chi",chi,scale,'.png " alt="Mean values of &chi;',chi,' per resolution for ',getLongName(aas),' in section ',Q,'."  height="400px" width="400px" align="texttop">',sep="");
}
return(string);
}
